...
class Conversation implements ConversationRequirements {
  ...
  Conversation() {
    ...
    this.replies = new String[]{"Mmm-hm", "That's great", "Interesting", "I see...", "I want know more about this"};
    this.detectedWords =  new String[]{"I","me", "am", "you", "my", "your", "are", "I'm", "You're"};
    this.changeWord = new String[]{"you","you", "are", "I","your", "my", "is", "You're", "I'm"};
  }
  ...
  public static void main(String[] arguments) {
    Conversation myConversation = new Conversation(); // creates a new object named myConversation
